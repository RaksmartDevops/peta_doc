...
. 在安全组列表，右键点击需要与云服务器进行绑定的安全组，在快捷菜单中选择**云服务器** > **绑定**。
+
image::/images/cloud_service/network/sg/sg_bind_vm_1.png[]

. 在弹出的云服务器选择窗口中，选择需要绑定的云服务器，点击**提交**，等待绑定成功即可。
+
...
. 在安全组列表，右键点击需要与云服务器进行绑定的安全组，在快捷菜单中选择**云服务器** > **解绑**。

. 在弹出的云服务选择窗口，选择需要解绑的云服务器，点击**提交**，等待解绑成功即可。
+
include::../../_components/note.adoc[]
仅解除当前安全组与选定资源之间的绑定关系。
include::../../_components/table_footer.adoc[]
+
image::/images/cloud_service/network/sg/sg_unbind_vm_1.png[]
...
. 在安全组列表，点击需要与云服务器进行绑定的安全组 ID，进入其详情页面。

. 点击**关联资源**页签，可以查看到与当前安全组关联的所有资源。
+
image::/images/cloud_service/network/sg/sg_bind_vm_2.png[]

. 点击**解绑**，弹出云服务器选择窗口。选择需要解绑安全组的云服务器，点击**提交**，等待解绑成功即可。
+
include::../../_components/note.adoc[]
仅解除当前安全组与选定资源之间的绑定关系。
include::../../_components/table_footer.adoc[]
