...
. 在**资源申请**页面，选择待申请的资源，此处以**云服务器**为例，进入申请云服务器页面。
...
. 云服务器参数配置完成后，点击**下一步：确认流程**，回到**发起申请**页面。
+
...
include::../../../../../../_components/table_footer.adoc[]
. 在**审批说明**中填写**用途说明**后，点击**提交申请**。
+
提交申请后，自动进入**我的申请** > **我发起的**页面，可以看到**流程状态**为``审批中``。
+
...
* **拒绝申请**
+
拒绝申请后，进入**我的申请** > **我发起的**页面，可以看到申请单的状态为``审批中``，并标注**审批已被拒绝**。
+
image::/images/cloud_service/services/approve/approve_wait_03.png[]
+
申请被拒绝后，系统不会创建相应的资源。用户可在相应的**详情**页**重新申请**。
