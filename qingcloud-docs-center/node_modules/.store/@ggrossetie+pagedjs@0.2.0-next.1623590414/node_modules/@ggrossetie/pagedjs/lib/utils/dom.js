...
exports.breakInsideAvoidNode = breakInsideAvoidNode;
  ...
  if (children) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var _child2 = _step.value;

        if (_child2 && _child2.dataset && _child2.dataset.breakInside === "avoid") {
          return _child2;
        }

        return breakInsideAvoidNode(_child2);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
