...
var Chunker = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Chunker, [{
    ...
    key: "handleOverruledBreakInside",
    value: function () {
      var _handleOverruledBreakInside = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(node) {
        var breakInsideNode, page, newBreakToken, breakInsideAvoidParent, overruleBreakInside;
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                breakInsideNode = (0, _dom.breakInsideAvoidNode)(node);
                ...
                page = this.addPage(); // QUESTION: should we emit the temporary page?
                //this.emit("page", page);

                _context5.next = 5;
                return page.layout(breakInsideNode, null, this.maxChars);

              case 5:
                newBreakToken = _context5.sent;
                breakInsideAvoidParent = newBreakToken && (0, _dom.breakInsideAvoidParentNode)(newBreakToken.node); // we are breaking inside a "break-inside: avoid" node which mean that we cannot comply with this rule!

                overruleBreakInside = breakInsideAvoidParent && breakInsideAvoidParent.dataset && breakInsideNode.dataset && breakInsideNode.dataset.ref === breakInsideAvoidParent.dataset.ref;
                ...
                return _context5.abrupt("return", typeof overruleBreakInside !== "undefined");
      ...
      function handleOverruledBreakInside(_x6) {
        return _handleOverruledBreakInside.apply(this, arguments);
      }

      return handleOverruledBreakInside;
    }()
  }, {
    key: "handleBreaks",
    value: function () {
    ...
    value: function layout(content, startAt) {
      ...
      return (0, _wrapAsyncGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7() {
        var breakToken, page, reflowCurrentPage, overruleBreakInside;
        return _regenerator["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 6:
                _context7.next = 8;
                return (0, _awaitAsyncGenerator2["default"])(_this.handleOverruledBreakInside(breakToken.node));

              case 8:
                overruleBreakInside = _context7.sent;
              ...
              case 14:
                if (reflowCurrentPage) {// reflow the current page because a "break" definition was overruled!
                } else {
                  page = _this.addPage();
                }
